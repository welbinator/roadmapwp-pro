 ...
 *
 * Hooks available:
 * - 'roadmapwp_display_ideas_shortcode' - Controls whether to display the shortcode output.
 * - 'wp_roadmap_hide_display_ideas_heading' - Controls heading visibility.
 * - 'wp_roadmap_custom_display_ideas_heading_text' - Customizes heading text.
 *
 * @since 1.0.0
 *
		...
		if ( $query->have_posts() ) :
			...
			<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3 px-6 py-8">
				...
				while ( $query->have_posts() ) :
					...
					$idea_class = '';
					if ( function_exists( 'RoadMapWP\Pro\Admin\Functions\get_idea_class_with_votes' ) ) {
