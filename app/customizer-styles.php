...
function custom_styles() {
    ...
    */
    ...
    if ( get_theme_mod( 'vote_button_background_color', '' ) ) {
        $custom_css .= '
    ...
    if ( get_theme_mod( 'tags_background_color', '' ) ) {
        $custom_css .= '
        .idea-tags a { 
            background: unset;
            background-image: unset;
    ...
    if ( get_theme_mod( 'submit_idea_button_background_color', '' ) ) {
        $custom_css .= '
    ...
    if ( get_theme_mod( 'filter_box_background_color', '' ) ) {
        $custom_css .= '
    ...
    * Roadmap Tabs Styles
    */
    if ( get_theme_mod( 'tabs_container_background_color', '' ) ) {
        $custom_css .= '
    ...
    if ( get_theme_mod( 'tabs_tab_background_color', '' ) ) {
        $custom_css .= '
